...
@else
    <form action="{{ url('/transaksi/' . $transaksi->id_transaksi . '/delete') }}" method="POST" id="form-delete">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr>
                            <th class="text-right col-3">Pelanggan :</th>
                            <td class="col-9">{{ $transaksi->pelanggan->nama }}</td>
                        </tr>

                        <tr>
                            <th class="text-right col-3">Produk :</th>
                            <td class="col-9">{{ $transaksi->produk->nama_produk }}</td>
                        </tr>

                        <tr>
                            <th class="text-right col-3">Tanggal :</th>
                            <td class="col-9">{{ \Carbon\Carbon::parse($transaksi->tanggal)->format('d-m-Y') }}</td>
                        </tr>
