...
@else
    <form action="{{ url('/produk/' . $produk->id_produk . '/delete') }}" method="POST" id="form-delete">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        Apakah Anda ingin menghapus data produk seperti di bawah ini?
                    </div>
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td class="col-9">{{ number_format($produk->harga, 2, ',', '.') }}</td>
                        </tr>
                    </table>
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                dataProduk.ajax.reload(); // reload datatable produk
                            } else {
                                $('.error-text').text('');
